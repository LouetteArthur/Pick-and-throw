...
def objective(trial: optuna.Trial) -> float:
    ...
    # Create the RL model
    env = TossingFlexpicker(GUI=False,reward_func=utils.implemented_rewards["neural_net"])
    if algo == "SAC":
    ...
    eval_envs = make_vec_env(lambda: TossingFlexpicker(GUI=False,reward_func=utils.implemented_rewards["neural_net"]), n_envs=N_EVAL_ENVS)
